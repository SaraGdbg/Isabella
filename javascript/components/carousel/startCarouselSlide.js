...
export default function startCarouselSlide(container, cards) {
  ...
  sliding(carouselCardContainer, carouselCards, totalCards);
}

function sliding(carouselCardContainer, carouselCards, totalCards) {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      callSlide(carouselCardContainer, carouselCards, totalCards);
    }, 1101);
  }, 3000);
}

function callSlide(carouselCardContainer, carouselCards, totalCards) {
  setTimeout(() => {
    sliding(carouselCardContainer, carouselCards, totalCards);
  }, 3000);
}
